  ...
  return (
    <footer className="w-full relative bg-background mt-16 md:mt-40">
      ...
      <div className='flex flex-col p-4'>
        <h2 className={`text-4xl sm:text-5xl font-bold ${styles.textGradient} self-start flex items-center gap-4 my-2`}>
          Bout
          <Image src="/BoutLogoSolo.svg" alt="Logo" width={50} height={50} className="h-8 w-8" priority />
        </h2>
        <span className='text-xl'>Bout&apos; the Future</span>
        <span className='flex items-center gap-2 font-mono text-sm'>
          <span className='material-symbols-outlined text-lg'>copyright</span>
          Bout 2024, All rights reserved
        </span>

        <div className='flex justify-between my-6 px-0 gap-8'>
